...
CREATE TABLE `work` (
    ...
    PRIMARY KEY (user_id, id_company),
    FOREIGN KEY (user_id) REFERENCES users(id),
...
CREATE TABLE `university` (
	id SERIAL,
    university_name CHAR(200)
    );
    
DROP TABLE IF EXISTS `education`;
CREATE TABLE `education` (
	user_id BIGINT UNSIGNED NOT NULL UNIQUE,
    id_university BIGINT UNSIGNED NOT NULL,
    specialization CHAR(200),
    
    PRIMARY KEY (user_id, id_university),
    FOREIGN KEY (user_id) REFERENCES university(id),
...
VALUES 
('Irina', 'Rissa', 'ii@ya.ru', 'qwerty28', '89255635465'),
('Kris', 'Prat', 'qw@ya.ru', 'qwerty27', '89257894563'),
('Lisa', 'Varg', 'fg@ya.ru', 'qwerty26', '89257894552'),
('Patrisia', 'Kis', 'zx@ya.ru', 'qwerty25', '89255545552'),
('Liza', 'Dis', 'gg@ya.ru', 'qwerty24', '89275545552'),
('Pol', 'Dis', 'pp@ya.ru', 'qwerty23', '89275545550'),    
('Koul', 'Prat', 'kk@ya.ru', 'qwerty22', '89275545551'),   
('Rouz', 'Douson', 'rr@ya.ru', 'qwerty21', '89205545551'),  
('Van', 'Helsing', 'hh@ya.ru', 'qwerty20', '89295545551'), 
('Ron', 'Polansky', 'yy@ya.ru', 'qwerty19', '89305545551');
